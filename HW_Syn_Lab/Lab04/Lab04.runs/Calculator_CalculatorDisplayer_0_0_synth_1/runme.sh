...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.runs/Calculator_CalculatorDisplayer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Calculator_CalculatorDisplayer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Calculator_CalculatorDisplayer_0_0.tcl
